...
| next | Moradi proposal meeting; coherence-penalty defensive ablation (optional); YOLO26 one-to-many re-dump; InternVideo2 dumps on YOLO rows → contrastive phrase head |
